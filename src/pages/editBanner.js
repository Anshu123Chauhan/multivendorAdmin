...
const EditBanner = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await axios.put(`${apiurl}/admin/banner/update`, payload);
    ...
    const handleGetBanner = async () => {
        ...
        try {
            const response = await axios.get(`${apiurl}/admin/banner/get/${id}`);
            const data = await response?.data;

            if (data.success) {
                const { image, tag, status } = data?.data;
